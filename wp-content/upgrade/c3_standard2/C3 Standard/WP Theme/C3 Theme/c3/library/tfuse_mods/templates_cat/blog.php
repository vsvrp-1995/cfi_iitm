          ...
          <div class="content">
            ...
            <div class="text">
				...
				<?php if (have_posts()) : $count = 0; ?>
                    ...
                    <?php } elseif (is_month()) { ?>
                    <h1><?php _e('Archive', 'tfuse'); ?> | <?php the_time('F, Y'); ?></h1><hr /><br />
            
                    <?php } elseif (is_year()) { ?>
                    <h1><?php _e('Archive', 'tfuse'); ?> | <?php the_time('Y'); ?></h1><hr /><br />
            
                    <?php } elseif (is_author()) { ?>
                    <h1><?php _e('Archive by Author', 'tfuse'); ?></h1><hr /><br />
            
                    <?php } elseif (is_tag()) { ?>
                    <h1><?php _e('Tag Archives:', 'tfuse'); ?> <?php echo single_tag_title('', true); ?></h1><hr /><br />

...
function the_widgets_init() {
    ...
    register_sidebar(array('name' => 'Homepage Sidebar','id' => 'sidebar-homepage','before_widget' => '<div id="%1$s" class="widget %2$s">','after_widget' => '</div>','before_title' => '<h3>','after_title' => '</h3>'));
    ...
    register_sidebar(array('name' => 'Footer 5','id' => 'footer-5','before_widget' => '<div id="%1$s" class="widget %2$s">','after_widget' => '</div>','before_title' => '<h3>','after_title' => '</h3>'));

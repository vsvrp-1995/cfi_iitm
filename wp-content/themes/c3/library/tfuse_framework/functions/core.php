...
if ( !function_exists('tfuse_image_post_align'))
{
    function tfuse_image_post_align()
    {
        global $post;
        $tfuse_post_thumb = array();
        $tfuse_post_thumb['thumb_width']  = get_post_meta($post->ID, PREFIX."_thumbnail_post_width", true);
        $tfuse_post_thumb['thumb_height']  = get_post_meta($post->ID, PREFIX."_thumbnail_post_height", true);
        $tfuse_post_thumb['thumb_align'] = get_post_meta($post->ID, PREFIX."_thumbnail_post_position", true);

        if ( empty($tfuse_post_thumb['thumb_width']) )  $tfuse_post_thumb['thumb_width']  = get_option(PREFIX.'_thumbnail_posts_width');
        if ( empty($tfuse_post_thumb['thumb_height']) ) $tfuse_post_thumb['thumb_height'] = get_option(PREFIX.'_thumbnail_posts_height');
        if ( empty($tfuse_post_thumb['thumb_align']) ||  $tfuse_post_thumb['thumb_align'] == 'default'  )  $tfuse_post_thumb['thumb_align']  = get_option(PREFIX.'_thumbnail_posts_position');

        return $tfuse_post_thumb;
